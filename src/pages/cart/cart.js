                                ...
                                <div className="item" key={item.product.id}>
                                    <div className="grid py-3">
                                        ...
                                        <div className="itemDesc">
                                            ...
                                            <span className="price">₹{round(item.product.price  * item.quantity, 2)*70}</span>
                        ...
                        <div className="payment p-3">
                            ...
                            <div className="summary py-3 my-2">
                                <div className="flex py-1">
                                    <span>Subtotal:</span>
                                    <span className="price">₹{round(cartTotal(), 2)*70}</span>
                                </div>
                                <div className="flex py-1">
                                ...
                                <div className=" flex py-1">
                                    <span>Total:</span>
                                    <span className="price">₹{round(cartTotal()*70 + SHIPPING_CHARGES, 2)}</span>
                                </div>
                            </div>
                        </div>
                    </div>
